...
export const WhatsAppButton = () => {
  ...
  return (
    <Button
      ...
      className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-30 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-full p-3 sm:p-4 shadow-xl hover:shadow-2xl transition-all duration-300 animate-bounce hover:animate-none group"
      size="icon"
    >
