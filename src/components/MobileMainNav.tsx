import { Home, LayoutGrid, Wrench } from "lucide-react";
...
export const MobileMainNav = ({
  ...
  const [activeTab, setActiveTab] = useState<"home" | "categories" | "repair">("home");
  ...
  const handleNavClick = useCallback(
    (item: typeof navItems[number]) => {
      ...
      const tabMap: Record<string, "home" | "categories"> = {
        "/": "home",
