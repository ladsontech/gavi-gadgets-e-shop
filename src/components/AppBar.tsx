...
export const AppBar = () => {
  ...
  return <header className="w-full bg-pink-500 shadow sticky top-0 z-20">
      <nav className="flex items-center justify-between px-3 py-2 sm:px-4 sm:py-3 md:py-4 max-w-6xl mx-auto bg-pink-700">
