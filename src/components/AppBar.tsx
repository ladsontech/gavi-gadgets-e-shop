...
export const AppBar = () => {
  ...
  return <header className="w-full bg-gradient-to-r from-pink-500 to-purple-500 shadow sticky top-0 z-20">
      <nav className="flex items-center justify-between px-4 py-3 md:py-4 max-w-4xl mx-auto">
        <div className="flex items-center gap-3" onClick={() => navigate("/")} style={{
        cursor: "pointer"
      }}>
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="p-2 rounded-full hover:bg-pink-100 focus-visible:ring-2 focus:outline-none text-white" aria-label="More options">
                <MoreVertical />
              </button>
            </DropdownMenuTrigger>
