...
const RepairCategoryCard: React.FC<{ category: RepairCategory; productCount: number }> = ({ category, productCount }) => {
  ...
  const whatsappNumber = "256740799577"; // Gavi Gadgets WhatsApp number
  const whatsappMessage = encodeURIComponent(`Hi! I'm interested in ${category.label} services. Can you help me?`);
      ...
      <div className="relative overflow-hidden rounded-xl border-2 border-gray-200 hover:border-pink-300 transition-all shadow-sm hover:shadow-lg bg-white h-full">
        ...
        <div className="relative p-6 flex flex-col items-center text-center h-full">
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full py-2.5 px-4 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
          >
